...
bd <- read_csv("~/Dropbox (Selva)/Ciencia de datos/Consultoría Estadística/Recursos/Externos/INE/Bases de datos/2018/Federal/Presidencia_2018_casilla.csv")
...
inp <- "~/Downloads/datos_geolectorales"
inegi <- st_read(paste(inp, "8e7d3ecce68a906de3f3f9b62bf55b81_geolectorales.shp", sep="/"), 
                 stringsAsFactors = FALSE, quiet = TRUE) %>%
  st_transform(4326) 
load("~/Documents/Git/electoral/data/inegi_traduccion.rda")
devtools::load_all(".")

bd <- preparar_info_censo(inegi, 
                          unidad_analisis="seccion", 
                          id_unidad_analisis=411, 
                          variable="psinder", 
                          weight="pobtot")
bd2 <-preparar_info_censo(inegi, 
                          unidad_analisis="seccion", 
                          id_unidad_analisis=411, 
                          variable="vph_inter", 
                          weight="tvivparhab")
bd3 <- preparar_info_censo(inegi, 
                          unidad_analisis="seccion", 
                          id_unidad_analisis=411, 
                          variable="vph_c_serv", 
                          weight="tvivparhab")
